...
function init ( ) {
  ...
  var settings = {
    units: 'mg/dL'
//    , ENABLE: `careportal delta direction upbat rawbg iob cob`
    , API_SECRET: '1qaz2wsx3edc4rfv'
    , timeFormat: '12'
    , nightMode: false
    , showRawbg: 'never'
  ...
  settings.DEFAULT_FEATURES = ['delta', 'direction', 'upbat', 'errorcodes', 'rawbg', 'iob', 'cob'];
  ...
  function adjustShownPlugins ( ) {
    ...
    if (settings.showPlugins !== '') {
      settings.showPlugins += ' delta direction upbat rawbg iob cob ';
